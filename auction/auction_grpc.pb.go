...
type AuctionClient interface {
	...
	Result(ctx context.Context, in *AuctionHouse, opts ...grpc.CallOption) (*Outcome, error)
}
...
func (c *auctionClient) Result(ctx context.Context, in *AuctionHouse, opts ...grpc.CallOption) (*Outcome, error) {
	out := new(Outcome)
...
type AuctionServer interface {
	...
	Result(context.Context, *AuctionHouse) (*Outcome, error)
...
func (UnimplementedAuctionServer) Result(context.Context, *AuctionHouse) (*Outcome, error) {
...
func _Auction_Result_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuctionServer).Result(ctx, req.(*AuctionHouse))
	}
	return interceptor(ctx, in, info, handler)
}
